...
* @createDate 2023-09-07 20:58:53
*/
@Service
...
//        });
        ...
        //增加提交变量
        log.info("提交数量={}",question.getSubmitNum());
        question.setSubmitNum(question.getSubmitNum()+1);
        questionService.updateById(question);
        log.info("提交数量222={}",question.getSubmitNum());
...
//        }, 10, TimeUnit.SECONDS);
        ...
        judgeFuture.thenRun(() -> {
            // 这里执行日志输出查看是否正常
            QuestionSubmit questionSubmit1 = super.getById(questionSubmitId);
            log.info("{}", questionSubmit1.getJudgeInfo());
            String jsonString = questionSubmit1.getJudgeInfo();
        ...
        log.info("最后questionSubmit={}",questionSubmit);
